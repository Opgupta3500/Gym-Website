...
function Aboutme() {
    ...
    return (
        <div className="flex justify-end items-center min-h-screen relative bg-cover bg-center" style={{ backgroundImage: `url(${gymImage2})` }}>
            <div className={`text-white text-left flex flex-col items-start p-8 ${showContent ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full'}`} data-aos="slide-right">
